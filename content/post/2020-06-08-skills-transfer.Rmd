...
Technical skills are at the cold face to sustain operations. Most support organisations face a shortage of some skills some time.  Some organisation cannot afford multiple levels of support.  When facing these situations the approach is to reduce the support levels and transferring skills to in-house capabilities. The purpose behind this can be to reduce costs and risks.
...
```
As expected we see skills are closely related to the complexity of the task. But, remeber these tasks are clustered together, therefore there must be some other comonality. Let's look at the parts and tools. 
