...
Technical skills are at the cold face to sustain operations. 

_The capabilities of support personnel is cannot repair everything and to be practical and also make economic sense we develop a support concept with multiple levels to deal with the increasing complexity the deeper the go into the equipment.  At first just replacing the battery is easy, next repairing the charger or changing he electric plug is but more tricky. Replacing the screen on the laptop is eyond most people. In the industry this also apply and met with different levels of support._

Most support organizations face a shortage of some skills some time.  Some organisation cannot afford multiple levels of support.  When facing these situations the approach is to reduce the support levels and transferring skills to in-house capabilities. The purpose behind this can be to reduce costs and risks.
